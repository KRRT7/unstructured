...
import numpy as np
from core_pdf.integrations.pdfminer.six.layout import LAParams, LTChar, LTContainer, LTTextBox
from core_pdf.integrations.pdfminer.six.pdftypes import PDFObjRef
from core_pdf.integrations.pdfminer.six.utils import decode_text, open_filename
